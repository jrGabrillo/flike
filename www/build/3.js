...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Group2PageModule", function() { return Group2PageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(81);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__group2__ = __webpack_require__(613);
...
var Group2PageModule = /** @class */ (function () {
    function Group2PageModule() {
    }
    Group2PageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__group2__["a" /* Group2Page */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["g" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__group2__["a" /* Group2Page */]),
            ],
            exports: [
                __WEBPACK_IMPORTED_MODULE_2__group2__["a" /* Group2Page */]
            ]
    ...
    return Group2PageModule;
}());

//# sourceMappingURL=group2.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return Group2Page; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(81);
...
var Group2Page = /** @class */ (function () {
    function Group2Page(navCtrl, navParams, prefs, db, loader, app, variables, chatService, translate, errorHandler) {
    ...
    Group2Page.prototype.ionViewWillEnter = function () {
    };
    Group2Page.prototype.ionViewDidLoad = function () {
        this.getChatrooms();
    };
    Group2Page.prototype.getChatrooms = function () {
        var _this = this;
        ...
        loader.present();
        this.chatService.getChatroomByGroup(__WEBPACK_IMPORTED_MODULE_4__providers_globals_globals__["group_2"], this.user.id)
            ...
            rooms.map(function (chatroom) {
                ...
                _this.chatService.getChatroomData(chatroom.payload.key)
                    ...
                    for (var key in thisroom.payload.val().userAccess) {
                        _loop_1(key);
                    }
                    for (var key in thisroom.payload.val().userMessageTimestamps) {
                        ...
                        if (key != _this.user.id && _this.lastMessageTimestamp != 0)
                            _this.lastMessageTimestamp = thisroom.payload.val().userMessageTimestamps[key].viewTimestamp;
                        //populate array
                        var timestamp = { id: key, viewTimestamp: thisroom.payload.val().userMessageTimestamps[key].viewTimestamp };
    ...
    Group2Page.prototype.pushOrUpdate = function (room) {
        var indexOfRoom = -1;
    ...
    Group2Page.prototype.goToChatroom = function (chatroom) {
        var activeNavs = this.app.getRootNavs();
        activeNavs[0].push("ChatPage", { chatroom: chatroom });
    };
    Group2Page.prototype.userExist = function (array, userId) {
        var exist = false;
